...
save_plots = TRUE #enable/disable saving PDFs (must be disabled to run in mybinder)                    
...
plot(1, type="n",
     ylim=ylims, xlim=range(delta_ts_fine), ylab = TeX("count rate R \\[counts h^{-1}\\]"), xlab=expression(paste("aggregation interval ", Delta, "t [h] ")), log="x")
